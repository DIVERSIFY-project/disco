...
public class NamingStrategy {
    ...
    private ArrayList<Integer> extractUsedIds(Collection<? extends NamedElement> names) throws NumberFormatException {
    ...
    public String createUniqueNodeInstanceName(DeploymentModel deployment) {
        return createUniqueName(deployment.getArtefactInstances(), NODE_INSTANCE_NAME_FORMAT);
    }
